...
By requiring the `models` folder, we load the [`index.js`](https://github.com/hakngrow/mern_tutorials_backend/blob/master/README.md#32-define-mongoose) from the `models` folder, which in turn loads the `tutorial` model defined [previously](https://github.com/hakngrow/mern_tutorials_backend/blob/master/README.md#33-tutorial-model).
